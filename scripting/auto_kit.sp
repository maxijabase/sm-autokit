...
{
	name			= "[TF2] Auto Kits",
	author			= "Classic, fix by ampere",
	description	= "Auto spawns ammo and med kits that work like normal kits.",
	version			= AK_VERSION,
	url				= "https://github.com/maxijabase/sm-autokit"
};
...
SQL_CreateTables()
{
	...
	Format(query,sizeof(query),"CREATE TABLE IF NOT EXISTS TF2_AutoKits (locX VARCHAR(32), locY VARCHAR(32), locZ VARCHAR(32), type INT, map VARCHAR(128));");
